...
if uname.nodename == 'duo':
    ...
    # config.val_targets = ['/nobackup3/bjgbiesseck/CASIA-Webface/faces_webface_112x112/lfw.bin', '/nobackup3/bjgbiesseck/CASIA-Webface/faces_webface_112x112/cfp_fp.bin', '/nobackup3/bjgbiesseck/CASIA-Webface/faces_webface_112x112/agedb_30.bin', 'bupt']
    ...
    config.rec = '/nobackup1/unico/datasets/face_recognition/CASIA-WebFace/imgs_crops_112x112'   # diolkos

    # config.val_targets = ['/nobackup/unico/datasets/face_recognition/1_CASIA-WebFace/faces_webface_112x112/lfw.bin']
    config.val_targets = ['/nobackup1/unico/datasets/face_recognition/1_CASIA-WebFace/faces_webface_112x112/lfw.bin', '/nobackup1/unico/datasets/face_recognition/1_CASIA-WebFace/faces_webface_112x112/cfp_fp.bin', '/nobackup1/unico/datasets/face_recognition/1_CASIA-WebFace/faces_webface_112x112/agedb_30.bin']
    # config.val_targets = ['bupt']
    ...
    config.path_subjs_list_to_merge = '/nobackup1/unico/datasets/face_recognition/CASIA-WebFace/merge_with_dataset_glint360k-glint360k-imgs_FACE_EMBEDDINGS_sim-range=[0.4,0.49]_EXCLUSIVE/dict_paths_new_subjs_base_subjs.json'
