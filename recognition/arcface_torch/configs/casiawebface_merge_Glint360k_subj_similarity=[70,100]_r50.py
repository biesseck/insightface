...
if uname.nodename == 'duo':
    ...
    config.path_subjs_list_to_merge = '/nobackup3/bjgbiesseck/CASIA-Webface/merge_with_dataset_glint360k-glint360k-imgs_FACE_EMBEDDINGS_sim-range=[0.7,1.0]/dict_paths_new_subjs_base_subjs.json'
