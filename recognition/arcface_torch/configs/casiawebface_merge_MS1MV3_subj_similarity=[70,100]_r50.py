...
if uname.nodename == 'duo':
    ...
    config.subjs_list_to_merge = '/nobackup/unico/datasets/face_recognition/1_CASIA-WebFace/merge_with_dataset_MS-Celeb-1M-ms1m-retinaface-t1-imgs_FACE_EMBEDDINGS_sim-range=[0.7,1.0]/dict_paths_new_subjs_base_subjs.json'
