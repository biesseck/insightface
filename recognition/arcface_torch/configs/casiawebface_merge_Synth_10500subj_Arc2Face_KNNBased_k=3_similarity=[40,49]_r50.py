...
if uname.nodename == 'duo':
    ...
    config.path_other_dataset = '/nobackup3/bjgbiesseck/CASIA-Webface/imgs_crops_112x112_FACE_EMBEDDINGS_R100_WebFace42M_ArcFace_newSynthIDs_Arc2Face_sim=[0.4,0.49]_10500ids_KNN_BASED/k=3/imgs_steps=25_DETECTED_FACES_RETINAFACE_scales=[0.25]_nms=0.4/imgs_112x112'
