...
if uname.nodename == 'duo':
    ...
    config.path_other_dataset = '/nobackup3/bjgbiesseck/CASIA-Webface/imgs_crops_112x112_FACE_EMBEDDINGS_newSynthIDs_Arc2Face_sim=[0.5,0.69]_10572ids_DETECTED_FACES_RETINAFACE_scales=[1.0]_nms=0.4/imgs'
    ...
    config.path_subjs_list_to_merge = ''
    ...
    config.path_other_dataset = '/hddevice/nobackup3/bjgbiesseck/datasets/face_recognition/CASIA-WebFace/imgs_crops_112x112_FACE_EMBEDDINGS_newSynthIDs_Arc2Face_sim=[0.5,0.69]_10572ids_DETECTED_FACES_RETINAFACE_scales=[1.0]_nms=0.4/imgs'
