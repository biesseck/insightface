...
if uname.nodename == 'duo':
    ...
    config.path_other_dataset = '/nobackup3/bjgbiesseck/CASIA-Webface/imgs_crops_112x112_FACE_EMBEDDINGS_newSynthIDs_Arc2Face_sim=[0.6,0.69]_110ids_KNN_BASED/imgs_steps=15_Arc2FaceDefault_DETECTED_FACES_RETINAFACE_scales=[1.0]_nms=0.4/imgs'
