...
if uname.nodename == 'duo':
    ...
    config.path_subjs_list_to_merge = '/nobackup3/bjgbiesseck/CASIA-Webface/merge_with_dataset_face_recognition-webface4m-imgs_FACE_EMBEDDINGS_R100_WebFace42M_ArcFace_sim-range=[0.7,1.0]/dict_paths_new_subjs_base_subjs.json'
