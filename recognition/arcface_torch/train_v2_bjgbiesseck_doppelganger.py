...
from dataset_bjgbiesseck_doppelganger import get_dataloader_doppelganger
from losses import CombinedMarginLoss
from losses_doppelganger import CombinedMarginLossDoppelgangerTwins
...
from utils.utils_callbacks_bjgbiesseck import CallBackLogging, CallBackVerification
...
def main(args):
    ...
    train_loader = get_dataloader_doppelganger(
        cfg.rec,
        local_rank,
        cfg.batch_size,
        cfg.dali,
    ...
    margin_loss = CombinedMarginLossDoppelgangerTwins(
        64,
        cfg.margin_list[0],
        cfg.margin_list[1],
        cfg.margin_list[2],
    ...
    module_partial_fc = PartialFC_V2_Doppelganger(
        margin_loss, cfg.embedding_size, cfg.num_classes,
        cfg.sample_rate, cfg.fp16)
    ...
    for epoch in range(start_epoch, cfg.num_epoch):
        ...
        for _, train_batch in enumerate(train_loader):
            ...
            loss: torch.Tensor = module_partial_fc(local_embeddings, local_labels, doppel_idxs)
